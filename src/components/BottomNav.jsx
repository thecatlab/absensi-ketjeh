...
const navItems = [
  ...
  { to: '/reservasi', label: 'Reservasi', icon: ReservationIcon },
  { to: '/admin', label: 'Admin', icon: ShieldIcon },
]

export default function BottomNav() {
  return (
    <nav className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[480px] bg-white border-t border-gray-200 px-2 py-2 z-50">
